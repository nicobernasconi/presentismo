                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium space-x-2">
                            <a href="<?= htmlspecialchars($baseUrl ?? '') ?>/turnos/<?= $shift['id'] ?>/editar" class="text-green-600 hover:text-green-900"><i class="fas fa-edit"></i></a>
                            <form action="<?= htmlspecialchars($baseUrl ?? '') ?>/turnos/<?= $shift['id'] ?>/eliminar" method="POST" style="display:inline;" data-confirm="¿Eliminar este turno?">
